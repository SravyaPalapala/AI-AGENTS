...
st.set_page_config(page_title="✈️AI-Driven Travel Guide", layout="wide")
st.markdown(
    """
    <style>
        .title {
...
# Title and subtitle
st.markdown('<h1 class="title">✈️ ✈️ AI-Driven Travel Guide</h1>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">Let AI Plan Your Dream Getaway – Tailored Flights, Stays & Adventures!..</p>', unsafe_allow_html=True)
...
st.markdown("### 📅 🕒 Time to Plan Your Escape")
...
st.sidebar.subheader("Craft your journery with Me!")
